...
def load_config(config_path: Path = _CONFIG_PATH) -> Config:
    ...
    config = Config(
        ...
        secrets=SecretsConfig(
            ...
            tradexyz_api_key=os.environ.get("TRADEXYZ_WALLET_ADDRESS") or os.environ.get("HYPERLIQUID_WALLET_ADDRESS", ""),
            tradexyz_api_secret=os.environ.get("TRADEXYZ_PRIVATE_KEY") or os.environ.get("HYPERLIQUID_PRIVATE_KEY", ""),
            tradexyz_builder_code=os.environ.get("TRADEXYZ_BUILDER_CODE", ""),
            dreamcash_api_key=os.environ.get("DREAMCASH_WALLET_ADDRESS") or os.environ.get("HYPERLIQUID_WALLET_ADDRESS", ""),
            dreamcash_api_secret=os.environ.get("DREAMCASH_PRIVATE_KEY") or os.environ.get("HYPERLIQUID_PRIVATE_KEY", ""),
